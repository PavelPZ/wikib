...
Table<T> _create<T extends RowData>(CreateFromMap<T> createFromMap) =>
    Table<T>(account: TableAccount.debugGetAccount(tableName, isEmulator), createFromMap: createFromMap);
TableBatch _createBatch() => TableBatch(account: TableAccount.debugGetAccount(tableName, isEmulator));
...
final tables = Tables(account: TableAccount.debugGetAccount('tables', isEmulator));
