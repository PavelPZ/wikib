...
Table<T> _create<T extends RowData>(CreateFromMap<T> createFromMap) =>
    Table<T>(account: DebugAccount.getAccount(tableName, isEmulator), createFromMap: createFromMap);
TableBatch _createBatch() => TableBatch(account: DebugAccount.getAccount(tableName, isEmulator));
...
final tables = Tables(account: DebugAccount.getAccount('tables', isEmulator));
